        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full lg:w-1/2">
            ...
            <div className="wow fadeInDown animated" data-wow-delay="0.3s" style={{ visibility: 'visible', '-webkit-animation-delay': '0.3s', '-moz-animation-delay': '0.3s', animationDelay: '0.3s' }}>
                <button className="border-0 bg-blue-600 text-white rounded-full w-40 h-12 duration-300 hover:opacity-75" type="submit"><i className="lni lni-arrow-right">Regístrate ahora</i></button>
            </div>
          </div>
          <div className="w-full lg:w-1/2">
